...
from data import get_init_embedding
  ...
  def _add_seq2seq(self):
    ...
    with tf.variable_scope('seq2seq'):
      ...
      with tf.variable_scope('embedding'):
        #if hps.mode=="decode":
        #   init_embeddings = self.trunc_norm_init([vsize, hps.emb_dim])
        #else:
        #init_embeddings= tf.constant(get_init_embedding(self._vocab._id_to_word, hps.emb_dim), dtype=tf.float32)
        #embedding = tf.get_variable("embedding", initializer=init_embeddings)
        embedding = tf.constant(get_init_embedding(self._vocab._id_to_word, hps.emb_dim), dtype=tf.float32)
